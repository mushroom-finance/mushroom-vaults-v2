...
abstract contract BaseStrategy is ReentrancyGuard {
     ...
     *  towards Mushroom's TVL calculations.
     * @dev
     *  You can override this field to set it to a non-zero value if some of the assets of this
     *  Strategy is somehow delegated inside another part of of Mushroom's ecosystem e.g. another Vault.
     *  Note that this value must be strictly less than or equal to the amount provided by
     *  `estimatedTotalAssets()` below, as the TVL calc will be total assets minus delegated assets.
     *  Also note that this value is used to determine the total assets under management by this
     *  strategy, for the purposes of computing the management fee in `Vault`
     * @return
     *  The amount of assets this strategy manages that should not be included in Mushroom's Total Value
     ...
     *  "at a loss" (keepers are always reimbursed by Mushroom).
     * @dev
     ...
     *  loss" (keepers are always reimbursed by Mushroom).
     * @dev
     *  `callCostInWei` must be priced in terms of `wei` (1e-18 ETH).
     *
